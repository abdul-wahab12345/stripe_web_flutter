...
@interface STP_Internal_AddressViewController : UIViewController
...
@interface STP_Internal_AddressViewController (SWIFT_EXTENSION(Stripe)) <UIGestureRecognizerDelegate>
